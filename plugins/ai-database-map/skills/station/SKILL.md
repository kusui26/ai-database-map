...
allowed-tools: mcp__plugin_ai-database-map_station-data__search_stations, mcp__plugin_ai-database-map_station-data__get_station_detail, mcp__plugin_ai-database-map_station-data__get_hazard_at_point, mcp__station-data__search_stations, mcp__station-data__get_station_detail, mcp__station-data__get_hazard_at_point
---
...
2. `get_station_detail` を grp と半径で呼ぶ。
3. `get_hazard_at_point` を同じ grp で呼ぶ。
4. 出力：
   - 駅名・都道府県・運営会社
