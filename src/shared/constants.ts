 ...
 *
 * ⚠ 260813 に**所得タブを足して 7 タブ＝460px** になり、40px ぶんは再びスライドする。
 * ここをさらに広げると地図が狭くなるため広げない、と判断している
 * （docs/260805_research_add_dataset_economy.md §16.3）。最後のタブが 26px 見えて
 * 「続きがある」と分かる状態は `tests/panel-layout.test.ts` が守る。
 *
